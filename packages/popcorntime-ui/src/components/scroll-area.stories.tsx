...
export const MovieList: Story = {
  render: () => {
    const movies = [
      ...
      { title: 'The Lord of the Rings: The Return of the King', year: 2003, genre: 'Fantasy', rating: 8.9 },
      ...
      <ScrollArea className="h-80 w-96 rounded-md border">
        <div className="p-4">
          ...
          <div className="space-y-1">
            {files.map((file, i) => (
              <div key={i} className="flex items-center justify-between p-2 hover:bg-muted rounded text-sm">
          ...
          {Array.from({ length: 20 }).map((_, i) => (
            <div key={i} className="p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                This is a very long piece of content that extends beyond the normal width of the container. 
                It demonstrates how the horizontal scrollbar works alongside the vertical one. 
