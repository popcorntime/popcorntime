...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A modal dialog component built with Radix UI Dialog primitives. Supports overlay, header, footer, and proper focus management.',
      },
    },
  },
  tags: ['autodocs'],
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            This is a description of what the dialog is for. It provides context about the action that will be performed.
          </DialogDescription>
        </DialogHeader>
        <div className="py-4">
