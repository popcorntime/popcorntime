...
import { Home, Settings, Search, Film, Tv, Star, MoreHorizontal } from 'lucide-react'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A sidebar navigation component with collapsible groups, search, and contextual content management.',
      },
    },
  },
  tags: ['autodocs'],
