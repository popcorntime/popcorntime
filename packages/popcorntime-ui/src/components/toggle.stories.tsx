...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A toggle button component with pressed/unpressed states, built with Radix UI Toggle primitives.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <div className="flex gap-4 items-center">
      <Toggle size="sm" aria-label="Bold">
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 12h9m-9-6h9m-9 12h9" />
        </svg>
      </Toggle>

      <Toggle aria-label="Italic">
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6L8 6 6 18l2 0" />
        </svg>
      </Toggle>

      <Toggle size="lg" aria-label="Underline">
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v9a3 3 0 003 3h0a3 3 0 003-3V3M7 21h10" />
        </svg>
      </Toggle>
    </div>
  ),
...
export const Disabled: Story = {
  render: () => (
    <div className="flex gap-4 items-center">
      ...
      <Toggle variant="outline" disabled pressed>Disabled Outline Pressed</Toggle>
    </div>
  ),
  parameters: {
    docs: {
