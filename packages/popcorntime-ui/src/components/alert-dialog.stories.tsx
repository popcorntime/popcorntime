    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will permanently delete your PopcornTime account and all associated data.
            You will lose access to your watchlist, favorites, and viewing history.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            "Inception" will be removed from your watchlist. You can add it back anytime
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will delete all downloaded movies and TV show episodes from your device.
            This will free up storage space but you'll need to download them again to watch offline.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel>Cancel</AlertDialogCancel>
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            You'll need to sign in again to access your personalized content,
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            You have unsaved changes to your preferences. If you close now, 
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Unable to connect to PopcornTime servers. Please check your internet connection
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            PopcornTime 2.1.0 is now available! This update includes performance improvements,
            bug fixes, and new features. The update will be installed automatically when you
      ...
      <AlertDialogContent className="max-w-lg">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-base">
            Upgrade to PopcornTime Premium to unlock exclusive features like 4K streaming,
            ad-free experience, offline downloads, and access to premium content libraries.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className="py-4">
