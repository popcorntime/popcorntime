...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'An avatar component for displaying user profile pictures with fallback support.',
      },
    },
  },
  tags: ['autodocs'],
...
export const UserList: Story = {
  render: () => {
    const users = [
      { name: 'John Doe', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face', initials: 'JD' },
      { name: 'Jane Smith', image: 'https://images.unsplash.com/photo-1494790108755-2616b86b5e0b?w=32&h=32&fit=crop&crop=face', initials: 'JS' },
      { name: 'Alice Johnson', image: '/broken.jpg', initials: 'AJ' },
      { name: 'Bob Wilson', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=32&h=32&fit=crop&crop=face', initials: 'BW' },
    ];
...
export const AvatarGroup: Story = {
  render: () => (
    <div className="flex -space-x-2">
      ...
      <Avatar className="border-2 border-background">
        <AvatarImage src="https://images.unsplash.com/photo-1494790108755-2616b86b5e0b?w=32&h=32&fit=crop&crop=face" alt="User 2" />
