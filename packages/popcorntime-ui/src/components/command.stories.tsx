...
import { Calendar, CreditCard, Settings, Smile, User, Film, Tv, Search, Star } from 'lucide-react'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Command palette component for fast navigation and action execution, built with cmdk.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Dialog: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Command dialog overlay for quick navigation and actions, similar to VS Code or Raycast',
      },
    },
  },
}
