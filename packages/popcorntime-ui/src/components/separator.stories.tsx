...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A separator component built with Radix UI primitives for visually or semantically separating content.',
      },
    },
  },
  tags: ['autodocs'],
...
export const CustomStyling: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Various separator styles including different thicknesses, colors, and border styles',
      },
    },
  },
}