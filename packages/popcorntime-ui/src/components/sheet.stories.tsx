...
import { Settings, User, Bell, Shield, Download, Star } from 'lucide-react'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A sheet dialog that slides in from the edge of the screen, commonly used for navigation menus or forms.',
      },
    },
  },
  tags: ['autodocs'],
    ...
    <Sheet>
      ...
      <SheetContent side="top">
        <SheetHeader>
          ...
          <SheetDescription>
            Recent updates and notifications from PopcornTime.
          </SheetDescription>
        </SheetHeader>
        <div className="py-4">
    ...
    <Sheet>
      ...
      <SheetContent side="bottom">
        <SheetHeader>
          ...
          <SheetDescription>
            Common actions you can perform quickly.
          </SheetDescription>
        </SheetHeader>
        <div className="py-6">
    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Configure your PopcornTime preferences.
          </SheetDescription>
        </SheetHeader>
