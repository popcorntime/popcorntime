...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A tooltip component built with Radix UI primitives. Shows contextual information on hover or focus.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <Tooltip>
      ...
      <TooltipContent className="max-w-xs">
        <p>This is a longer tooltip with more detailed information that wraps to multiple lines when the content is too long for a single line.</p>
      </TooltipContent>
    </Tooltip>
  ),
  parameters: {
