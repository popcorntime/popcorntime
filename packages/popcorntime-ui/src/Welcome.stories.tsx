    ...
    docs: {
      page: () => (
        <div className="max-w-4xl mx-auto p-6">
          <h1 className="text-3xl font-bold mb-6">@popcorntime/ui Storybook</h1>
          
          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-muted-foreground mb-8">
              Welcome to the PopcornTime UI component library documentation. This Storybook contains 
              interactive examples and documentation for all our reusable UI components.
            </p>

            <h2 className="text-xl font-semibold mb-4">📚 What you'll find here</h2>
            <ul className="space-y-2 mb-8">
              <li><strong>Component Examples</strong> - Interactive stories showing components in different states</li>
              <li><strong>Documentation</strong> - Comprehensive guides and prop tables</li>
              <li><strong>Accessibility Testing</strong> - Built-in a11y checks for inclusive design</li>
              <li><strong>Design Guidelines</strong> - Best practices and usage patterns</li>
            </ul>

            <h2 className="text-xl font-semibold mb-4">🎨 Component Coverage</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="space-y-2">
                <h3 className="font-medium">Form Components</h3>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Button - Primary, secondary, and specialized actions</li>
            ...
            <div className="bg-muted p-4 rounded-lg mb-8">
              <p className="text-sm mb-2">To use these components in your project:</p>
      ...
      <Input placeholder="Enter text..." />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">Modify props in real-time</p>
              </div>
              <div className="text-center p-4 border rounded-lg">
                <div className="text-2xl mb-2">♿</div>
                <h3 className="font-medium mb-1">Accessibility</h3>
                <p className="text-sm text-muted-foreground">Built-in a11y testing</p>
              </div>
              <div className="text-center p-4 border rounded-lg">
                <div className="text-2xl mb-2">📱</div>
